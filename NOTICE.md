...
The current implementation is distributed under the MIT license in [LICENSE](LICENSE). The original engine notice above remains included. The npm package is named `@ahoh.tech/co-memo`; this repository does not automatically publish on push.
