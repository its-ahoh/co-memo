            ...
            : [
                ...retained,
                {
                  hooks: [
                    {
                      type: 'command',
                      command: `${base} bridge --agent ${agent} --event ${event} --stdin${marker}`,
                      timeout: 15,
                    },
                  ],
                },
